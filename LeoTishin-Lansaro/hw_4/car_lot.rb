...
def show_all_cars(cars)
  cars.each do |car|
    ...
    puts "***** This car is NOT so great for earth! ***** " unless car[:is_electric] == true
    puts "***** + It is an old car *****" if car[:year] < 2000
    puts ""
  end
end
...
tesla = {brand: "Tesla", model: "X", year: 2016, price: 85000, is_electric: true}
