...
| 6          | Review and complete `robot.rb` and `thermostat.rb` on your own. <br> Read ch. 2-4 in Well Grounded Rubyist. <br> Catch up on all homework & reading (connecting with your group or attending office hours is recommended!). | [06_Ruby_Fundamentals](https://github.com/ga-students/bewd_sf_10/tree/master/06_Ruby_Fundamentals) | Monday, August 24th | Wednesday, August 26th |
| 7          |            | - | - | - |
| 8          |            | - | - | - |
| 9          |            | - | - | - |
| ...        |            | - | - | - |
