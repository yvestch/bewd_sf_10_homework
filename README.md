...
| 4          | Complete love_post.rb and car_lot.rb on your own. <br> (*We'll cover APIs on Wednesday) Build get_it.rb using these 2 APIs: [Reddit](https://www.reddit.com/.json) and [Mashable](http://mashable.com/stories.json). <br> Bonus in car_lot.rb: write a method that accepts an unlimited number of cars, and transforms them into an array. <br> Bonus in APIs: Save results to a CSV file. | [04_Ruby_Fundamentals](https://github.com/ga-students/bewd_sf_10/tree/master/04_Ruby_Fundamentals) | Monday, August 17th | Wednesday, August 19th |
| 5          |            | - | - | - |
| 6          |            | - | - | - |
| 7          |            | - | - | - |
| 8          |            | - | - | - |
